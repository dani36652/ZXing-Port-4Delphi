...
type
  ...
  JAztecCode = interface;
  JAztecDetectorResult = interface;
  JAztecReader = interface;
  JAztecWriter = interface;
  JBarcodeFormat = interface;
  JBarcodeMatrix = interface;
  JBinarizer = interface;
  JBinaryBitmap = interface;
  JBitArray = interface;
  JBitMatrix = interface;
  JBitSource = interface;
  JBizcardResultParser = interface;
  JBookmarkDoCoMoResultParser = interface;
  JByQuadrantReader = interface;
  JByteMatrix = interface;
  JCalendarParsedResult = interface;
  JCharacterSetECI = interface;
  JChecksumException = interface;
  JCodaBarReader = interface;
  JCodaBarWriter = interface;
  JCode128Reader = interface;
  JCode128Writer = interface;
  JCode39Reader = interface;
  JCode39Writer = interface;
  JCode93Reader = interface;
  JCode93Writer = interface;
  JCompaction = interface;
  JDataCharacter = interface;
  JDataMask = interface;
  JDataMatrixReader = interface;
  JDataMatrixWriter = interface;
  JDecodeHintType = interface;
  JDecodedObject = interface;
  JDecoder = interface;
  JDecoderResult = interface;
  JDefaultGridSampler = interface;
  JDefaultPlacement = interface;
  JDetector = interface;
  JDetectorResult = interface;
  JDimension = interface;
  JDimensions = interface;
  JEAN13Reader = interface;
  JEAN13Writer = interface;
  JEAN8Reader = interface;
  JEAN8Writer = interface;
  JECIEncoderSet = interface;
  JECIInput = interface;
  JECIStringBuilder = interface;
  JEmailAddressParsedResult = interface;
  JEmailAddressResultParser = interface;
  JEmailDoCoMoResultParser = interface;
  JEncodeHintType = interface;
  JEncoder = interface;
  ...
  JGridSampler = interface;
  JHighLevelEncoder = interface;
  JHybridBinarizer = interface;
  JISBNParsedResult = interface;
  JISBNResultParser = interface;
  JITFReader = interface;
  JITFWriter = interface;
  JInvertedLuminanceSource = interface;
  JLuminanceSource = interface;
  JMathUtils = interface;
  JMaxiCodeReader = interface;
  JMinimalECIInput = interface;
  JMinimalEncoder = interface;
  JMode = interface;
  JModulusGF = interface;
  ...
  JPDF417Writer = interface;
  JParsedResult = interface;
  ...
  JQRCodeReader = interface;
  JQRCodeWriter = interface;
  JRGBLuminanceSource = interface;
  JRSS14Reader = interface;
  JRSSExpandedReader = interface;
  JRSSUtils = interface;
  JReader = interface;
  JReaderException = interface;
  JReedSolomonDecoder = interface;
  JReedSolomonEncoder = interface;
  JReedSolomonException = interface;
  JResult = interface;
  JResultMetadataType = interface;
  JResultParser = interface;
  JResultPoint = interface;
  JResultPointCallback = interface;
  ...
  JSymbolInfo = interface;
  JSymbolShapeHint = interface;
  JTelParsedResult = interface;
  JTelResultParser = interface;
  JTextParsedResult = interface;
  JToken = interface;
  JUPCAReader = interface;
  JUPCAWriter = interface;
  JUPCEANReader = interface;
  JUPCEANWriter = interface;
  JUPCEReader = interface;
  JUPCEWriter = interface;
  ...
  JWriter = interface;
  JWriterException = interface;
  Jaztec_decoder_Decoder = interface;
  Jaztec_detector_Detector = interface;
  Jdatamatrix_detector_Detector = interface;
  Jdecoder_Decoder = interface;
  Jdecoder_Version = interface;
  Jdetector_Detector = interface;
  Jdetector_FinderPattern = interface;
  Jencoder_Encoder = interface;
  Jencoder_ErrorCorrection = interface;
  Jencoder_HighLevelEncoder = interface;
  Jqrcode_decoder_Decoder = interface;

  JMaxiCodeReaderClass = interface(JObjectClass)
    ['{95C45F21-F145-480B-9FD1-0A8657FF92CF}']
    {class} function init: JMaxiCodeReader; cdecl;
  end;

  [JavaSignature('com/google/zxing/maxicode/MaxiCodeReader')]
  JMaxiCodeReader = interface(JObject)
    ['{31788EC1-D891-4C6A-AEA0-F5CE726D7685}']
    function decode(binaryBitmap: JBinaryBitmap; map: JMap): JResult; overload; cdecl;
    function decode(binaryBitmap: JBinaryBitmap): JResult; overload; cdecl;
  ...
  Jdecoder_DecoderClass = interface(JObjectClass)
    ['{16BF24AD-0887-4DDC-808E-BDFD259E0E8D}']
  ...
  Jdecoder_Decoder = interface(JObject)
    ['{0235E2AA-F68E-4C73-AD4A-5E08231AAF53}']
    function decode(bitMatrix: JBitMatrix; map: JMap): JDecoderResult; overload; cdecl;
    function decode(bitMatrix: JBitMatrix): JDecoderResult; overload; cdecl;
  end;
  ...
  JByQuadrantReaderClass = interface(JObjectClass)
    ['{43AD28D6-E490-4740-BFB6-64F552823F94}']
    {class} function init(reader: JReader): JByQuadrantReader; cdecl;
  end;

  [JavaSignature('com/google/zxing/multi/ByQuadrantReader')]
  JByQuadrantReader = interface(JObject)
    ['{1E20D72A-7C54-4BD4-A83C-AFE34D0CE086}']
    function decode(binaryBitmap: JBinaryBitmap; map: JMap): JResult; overload; cdecl;
    function decode(binaryBitmap: JBinaryBitmap): JResult; overload; cdecl;
    procedure reset; cdecl;
  end;
  ...
  JMultipleBarcodeReaderClass = interface(IJavaClass)
    ['{9160A7E8-BDAF-4741-9A49-F946582C9202}']
  end;

  [JavaSignature('com/google/zxing/multi/MultipleBarcodeReader')]
  JMultipleBarcodeReader = interface(IJavaInstance)
    ['{FB7F685A-7994-4E2E-B904-BAF9FA12E00C}']
    function decodeMultiple(binaryBitmap: JBinaryBitmap): TJavaObjectArray<JResult>; overload; cdecl;
    function decodeMultiple(binaryBitmap: JBinaryBitmap; map: JMap): TJavaObjectArray<JResult>; overload; cdecl;
  end;
  ...
  JGenericMultipleBarcodeReaderClass = interface(JObjectClass)
    ['{8EA13E73-E66B-4285-889E-C71CBDA7360B}']
    {class} function init(reader: JReader): JGenericMultipleBarcodeReader; cdecl;
  end;

  [JavaSignature('com/google/zxing/multi/GenericMultipleBarcodeReader')]
  JGenericMultipleBarcodeReader = interface(JObject)
    ['{4848A54E-8B92-455F-B713-601E5FAE1454}']
    function decodeMultiple(binaryBitmap: JBinaryBitmap; map: JMap): TJavaObjectArray<JResult>; overload; cdecl;
    function decodeMultiple(binaryBitmap: JBinaryBitmap): TJavaObjectArray<JResult>; overload; cdecl;
  end;
  ...
  JDecodeHintTypeClass = interface(JEnumClass)
    ['{75BCA849-B52B-4E70-9ED2-9F63A484F3DF}']
    ...
    {class} function valueOf(string_1: JString): JDecodeHintType; cdecl;
  ...
  JDecodeHintType = interface(JEnum)
    ['{D41E6C6F-B744-4D58-9214-859549EAC5AB}']
  ...
  JReaderExceptionClass = interface(JExceptionClass)
    ['{46D35F72-380D-4B7B-B68A-1734B1BE644A}']
    {class} procedure setStackTrace(boolean: Boolean); cdecl;
  end;

  [JavaSignature('com/google/zxing/ReaderException')]
  JReaderException = interface(JException)
    ['{CF85DF2C-7A66-4C9A-B1D7-49FFE1E883F8}']
  ...
  JQRCodeReaderClass = interface(JObjectClass)
    ['{4BB9A240-2412-4DD7-A90D-D41FD3390AAB}']
    {class} function init: JQRCodeReader; cdecl;
  end;

  [JavaSignature('com/google/zxing/qrcode/QRCodeReader')]
  JQRCodeReader = interface(JObject)
    ['{EE8AFE07-D8D1-4077-BD69-09E8978D9D39}']
    function decode(binaryBitmap: JBinaryBitmap; map: JMap): JResult; overload; cdecl;
    function decode(binaryBitmap: JBinaryBitmap): JResult; overload; cdecl;
    procedure reset; cdecl;
  end;
  ...
  JFinderPatternFinderClass = interface(JObjectClass)
    ['{6324C319-4CEF-4756-9579-AB66EE6540F4}']
    {class} function init(bitMatrix: JBitMatrix): JFinderPatternFinder; overload; cdecl;
    {class} function init(bitMatrix: JBitMatrix; resultPointCallback: JResultPointCallback): JFinderPatternFinder; overload; cdecl;
  end;

  [JavaSignature('com/google/zxing/qrcode/detector/FinderPatternFinder')]
  JFinderPatternFinder = interface(JObject)
    ['{4D271B76-3189-493A-BAEC-70C8EAFDFE81}']
  end;
  ...
  Jdetector_DetectorClass = interface(JObjectClass)
    ['{2071BE31-BE5C-483B-82D6-F517E3189BCC}']
  ...
  Jdetector_Detector = interface(JObject)
    ['{96907FD5-AB0A-4856-AAAA-A9B41BBDBFAD}']
    function detect(map: JMap): JDetectorResult; overload; cdecl;
    function detect: JDetectorResult; overload; cdecl;
  end;
  ...
  JFinderPatternInfoClass = interface(JObjectClass)
    ['{68D020C1-74DD-464C-9D57-B52F91E913DC}']
    {class} function init(finderPatterns: TJavaObjectArray<JFinderPattern>): JFinderPatternInfo; cdecl;
  end;

  [JavaSignature('com/google/zxing/qrcode/detector/FinderPatternInfo')]
  JFinderPatternInfo = interface(JObject)
    ['{EAEF7A18-B04B-44E6-BB6D-23A1D705EB42}']
    function getBottomLeft: Jdetector_FinderPattern; cdecl;
    function getTopLeft: Jdetector_FinderPattern; cdecl;
    function getTopRight: Jdetector_FinderPattern; cdecl;
  end;
  ...
  JByteMatrixClass = interface(JObjectClass)
    ['{92F4B427-8A97-4127-AA18-11F23EB63A76}']
    {class} function init(int: Integer; int_1: Integer): JByteMatrix; cdecl;
  end;

  [JavaSignature('com/google/zxing/qrcode/encoder/ByteMatrix')]
  JByteMatrix = interface(JObject)
    ['{32255EB2-60DD-4BBE-9822-1772171F5E89}']
    procedure clear(byte: Byte); cdecl;
    function get(int: Integer; int_1: Integer): Byte; cdecl;
    function getArray: TJavaArray<Byte>; cdecl;
    function getHeight: Integer; cdecl;
    function getWidth: Integer; cdecl;
    procedure &set(int: Integer; int_1: Integer; boolean: Boolean); overload; cdecl;
    procedure &set(int: Integer; int_1: Integer; byte: Byte); overload; cdecl;
    procedure &set(int: Integer; int_1: Integer; int_2: Integer); overload; cdecl;
    function toString: JString; cdecl;
  end;
  TJByteMatrix = class(TJavaGenericImport<JByteMatrixClass, JByteMatrix>) end;

  Jencoder_EncoderClass = interface(JObjectClass)
    ['{02B170A8-3746-4B83-8762-FC0FB7332A0C}']
    {class} function chooseMode(string_1: JString): JMode; cdecl;
    {class} function encode(string_1: JString; errorCorrectionLevel: JErrorCorrectionLevel; map: JMap): JQRCode; overload; cdecl;
    {class} function encode(string_1: JString; errorCorrectionLevel: JErrorCorrectionLevel): JQRCode; overload; cdecl;
  end;

  [JavaSignature('com/google/zxing/qrcode/encoder/Encoder')]
  Jencoder_Encoder = interface(JObject)
    ['{B64B5738-28FC-4B16-8EA7-BAC4C3DDBC1F}']
  end;
  TJencoder_Encoder = class(TJavaGenericImport<Jencoder_EncoderClass, Jencoder_Encoder>) end;

  JQRCodeClass = interface(JObjectClass)
    ['{7CC27FC7-E541-442C-8FD8-6B44A7FEE38A}']
    {class} function _GetNUM_MASK_PATTERNS: Integer; cdecl;
    {class} function init: JQRCode; cdecl;
    {class} function isValidMaskPattern(int: Integer): Boolean; cdecl;
  ...
  JQRCode = interface(JObject)
    ['{6FBCD3CF-3377-4F15-BB6A-2F7E7562888F}']
  ...
  Jqrcode_decoder_Decoder = interface(JObject)
    ['{1351F99B-B8F7-454C-A96B-C14A5473356C}']
    function decode(bitMatrix: JBitMatrix; map: JMap): JDecoderResult; overload; cdecl;
    function decode(bitMatrix: JBitMatrix): JDecoderResult; overload; cdecl;
    function decode(booleanss: TJavaArray<Boolean>; map: JMap): JDecoderResult; overload; cdecl;
    function decode(booleanss: TJavaArray<Boolean>): JDecoderResult; overload; cdecl;
  end;
  ...
  JDataMaskClass = interface(JEnumClass)
    ['{ACBD4E1F-FF6B-4F75-8324-3EDD1F21D5C1}']
    ...
    {class} function valueOf(string_1: JString): JDataMask; cdecl;
  ...
  JErrorCorrectionLevelClass = interface(JEnumClass)
    ...
    {class} function forBits(int: Integer): JErrorCorrectionLevel; cdecl;
    {class} function valueOf(string_1: JString): JErrorCorrectionLevel; cdecl;
  ...
  JErrorCorrectionLevel = interface(JEnum)
    ['{3A294A62-14FD-45C6-8569-06B9E25088A7}']
  ...
  JQRCodeDecoderMetaDataClass = interface(JObjectClass)
    ['{3B34605C-5433-4AA8-8A15-170731885974}']
  end;

  [JavaSignature('com/google/zxing/qrcode/decoder/QRCodeDecoderMetaData')]
  JQRCodeDecoderMetaData = interface(JObject)
    ['{53054D7F-8FD1-488E-ACB1-ED3AF90E4666}']
    procedure applyMirroredCorrection(resultPoints: TJavaObjectArray<JResultPoint>); cdecl;
  ...
  Jdecoder_VersionClass = interface(JObjectClass)
    ['{36DF1DF5-A3FA-4CE2-8C24-250C67061CDB}']
    {class} function getProvisionalVersionForDimension(int: Integer): Jdecoder_Version; cdecl;
    {class} function getVersionForNumber(int: Integer): Jdecoder_Version; cdecl;
  end;

  [JavaSignature('com/google/zxing/qrcode/decoder/Version')]
  Jdecoder_Version = interface(JObject)
    ['{7DA2EA41-A81B-4894-84D4-387125E6B34B}']
    function getAlignmentPatternCenters: TJavaArray<Integer>; cdecl;
    function getDimensionForVersion: Integer; cdecl;
    function getECBlocksForLevel(errorCorrectionLevel: JErrorCorrectionLevel): JVersion_ECBlocks; cdecl;
  ...
  JModeClass = interface(JEnumClass)
    ['{3243063E-4C06-4B2B-A04A-F2686E7A6D4C}']
    ...
    {class} function forBits(int: Integer): JMode; cdecl;
    {class} function valueOf(string_1: JString): JMode; cdecl;
  ...
  JResultMetadataTypeClass = interface(JEnumClass)
    ['{6262C16A-4E68-42DE-BBB1-76DEC003F512}']
    ...
    {class} function valueOf(string_1: JString): JResultMetadataType; cdecl;
  ...
  JResultMetadataType = interface(JEnum)
    ['{FBB52D24-A1A4-4EB0-920B-1EC5878B94D6}']
  end;
  ...
  JResultClass = interface(JObjectClass)
    ['{72437AE1-3EEC-447D-BFD5-68F1FCAA082C}']
    {class} function init(string_1: JString; bytes: TJavaArray<Byte>; resultPoints: TJavaObjectArray<JResultPoint>; barcodeFormat: JBarcodeFormat): JResult; overload; cdecl;
    {class} function init(string_1: JString; bytes: TJavaArray<Byte>; resultPoints: TJavaObjectArray<JResultPoint>; barcodeFormat: JBarcodeFormat; long: Int64): JResult; overload; cdecl;
    {class} function init(string_1: JString; bytes: TJavaArray<Byte>; int: Integer; resultPoints: TJavaObjectArray<JResultPoint>; barcodeFormat: JBarcodeFormat; long: Int64): JResult; overload; cdecl;
  end;

  [JavaSignature('com/google/zxing/Result')]
  JResult = interface(JObject)
    ['{B0480EC1-9F8B-4982-8EAC-FC4C6A1173E2}']
    procedure addResultPoints(resultPoints: TJavaObjectArray<JResultPoint>); cdecl;
    ...
    procedure putMetadata(resultMetadataType: JResultMetadataType; object_1: JObject); cdecl;
    function toString: JString; cdecl;
  end;
  TJResult = class(TJavaGenericImport<JResultClass, JResult>) end;

  JMultiFormatWriterClass = interface(JObjectClass)
    ['{8D895DA1-838B-4B67-B0F9-B1137A50E0C3}']
  ...
  JMultiFormatWriter = interface(JObject)
    ['{58BDF514-63E4-47DC-836F-1DC6FACF26A1}']
    function encode(string_1: JString; barcodeFormat: JBarcodeFormat; int: Integer; int_1: Integer; map: JMap): JBitMatrix; overload; cdecl;
    function encode(string_1: JString; barcodeFormat: JBarcodeFormat; int: Integer; int_1: Integer): JBitMatrix; overload; cdecl;
  end;
  ...
  JResultPointClass = interface(JObjectClass)
    ['{385E89E9-AA7F-4C48-9167-519AAE42773E}']
    {class} function distance(resultPoint: JResultPoint; resultPoint_1: JResultPoint): Single; cdecl;
    {class} function init(float: Single; float_1: Single): JResultPoint; cdecl;
    {class} procedure orderBestPatterns(resultPoints: TJavaObjectArray<JResultPoint>); cdecl;
  end;

  [JavaSignature('com/google/zxing/ResultPoint')]
  JResultPoint = interface(JObject)
    ['{AD5777D6-749C-41AB-B749-58714A44C752}']
  ...
  JGridSamplerClass = interface(JObjectClass)
    ['{9AFAC96B-303D-45D6-9D62-3FF5898AD09A}']
  ...
  JGridSampler = interface(JObject)
    ['{D4C48ABF-DEFF-4888-B303-0E9DF7D4E0A0}']
    function sampleGrid(bitMatrix: JBitMatrix; int: Integer; int_1: Integer; perspectiveTransform: JPerspectiveTransform): JBitMatrix; overload; cdecl;
    function sampleGrid(bitMatrix: JBitMatrix; int: Integer; int_1: Integer; float: Single; float_1: Single; float_2: Single; float_3: Single; float_4: Single; float_5: Single; float_6: Single; float_7: Single; float_8: Single; float_9: Single; float_10: Single; float_11: Single; float_12: Single; float_13: Single; float_14: Single; float_15: Single): JBitMatrix; overload; cdecl;
  end;
  TJGridSampler = class(TJavaGenericImport<JGridSamplerClass, JGridSampler>) end;

  JECIInputClass = interface(IJavaClass)
    ['{91D6E49F-5855-4BAF-89A9-6B804E319362}']
  end;

  [JavaSignature('com/google/zxing/common/ECIInput')]
  JECIInput = interface(IJavaInstance)
    ['{59B3A2CC-0F7A-4D73-90C4-43E46C19E909}']
    function charAt(int: Integer): Char; cdecl;
    function getECIValue(int: Integer): Integer; cdecl;
    function haveNCharacters(int: Integer; int_1: Integer): Boolean; cdecl;
    function isECI(int: Integer): Boolean; cdecl;
    function length: Integer; cdecl;
    function subSequence(int: Integer; int_1: Integer): JCharSequence; cdecl;
  end;
  TJECIInput = class(TJavaGenericImport<JECIInputClass, JECIInput>) end;

  JBitArrayClass = interface(JObjectClass)
    ['{0E7DA91C-5DA5-483B-A653-BD966B1A91DC}']
    {class} function init: JBitArray; overload; cdecl;
    {class} function init(int: Integer): JBitArray; overload; cdecl;
  end;

  [JavaSignature('com/google/zxing/common/BitArray')]
  JBitArray = interface(JObject)
    ['{1CA401FC-A33C-4FE2-B363-25A133983811}']
    procedure appendBit(boolean: Boolean); cdecl;
    procedure appendBitArray(bitArray: JBitArray); cdecl;
    procedure appendBits(int: Integer; int_1: Integer); cdecl;
    procedure clear; cdecl;
    function clone: JBitArray; overload; cdecl;
    function equals(object_1: JObject): Boolean; cdecl;
    procedure flip(int: Integer); cdecl;
    function get(int: Integer): Boolean; cdecl;
    function getBitArray: TJavaArray<Integer>; cdecl;
    function getNextSet(int: Integer): Integer; cdecl;
    function getNextUnset(int: Integer): Integer; cdecl;
    function getSize: Integer; cdecl;
    function getSizeInBytes: Integer; cdecl;
    function hashCode: Integer; cdecl;
    function isRange(int: Integer; int_1: Integer; boolean: Boolean): Boolean; cdecl;
    procedure reverse; cdecl;
    procedure &set(int: Integer); cdecl;
    procedure setBulk(int: Integer; int_1: Integer); cdecl;
    procedure setRange(int: Integer; int_1: Integer); cdecl;
    procedure toBytes(int: Integer; bytes: TJavaArray<Byte>; int_1: Integer; int_2: Integer); cdecl;
    function toString: JString; cdecl;
  ...
  JMonochromeRectangleDetectorClass = interface(JObjectClass)
    ['{2AFADA8B-EFD0-4176-A26F-ADA8EE07C4A5}']
  ...
  JMonochromeRectangleDetector = interface(JObject)
    ['{4CA232F0-E7DA-4281-85B6-59676B142AFE}']
  ...
  JWhiteRectangleDetectorClass = interface(JObjectClass)
    ['{B3A13347-7503-48D5-ACAB-F8265EF3D4AB}']
    {class} function init(bitMatrix: JBitMatrix; int: Integer; int_1: Integer; int_2: Integer): JWhiteRectangleDetector; overload; cdecl;
    {class} function init(bitMatrix: JBitMatrix): JWhiteRectangleDetector; overload; cdecl;
  end;

  [JavaSignature('com/google/zxing/common/detector/WhiteRectangleDetector')]
  JWhiteRectangleDetector = interface(JObject)
    ['{9A251265-14B0-4BDC-A9FB-DFCE871A0CF9}']
    function detect: TJavaObjectArray<JResultPoint>; cdecl;
  end;
  ...
  JMathUtilsClass = interface(JObjectClass)
    ['{3C271C3F-25B2-4329-B9CA-68A0FE183EF6}']
    {class} function distance(int: Integer; int_1: Integer; int_2: Integer; int_3: Integer): Single; overload; cdecl;
    {class} function distance(float: Single; float_1: Single; float_2: Single; float_3: Single): Single; overload; cdecl;
    {class} function round(float: Single): Integer; cdecl;
    {class} function sum(ints: TJavaArray<Integer>): Integer; cdecl;
  end;

  [JavaSignature('com/google/zxing/common/detector/MathUtils')]
  JMathUtils = interface(JObject)
    ['{7F0B46DB-75A3-4A9C-B3B1-F8DD619C061F}']
  end;
  TJMathUtils = class(TJavaGenericImport<JMathUtilsClass, JMathUtils>) end;

  JBitSourceClass = interface(JObjectClass)
    ['{A7A7C1D6-A582-4EB8-9566-9BE8FAF10BA6}']
    {class} function init(bytes: TJavaArray<Byte>): JBitSource; cdecl;
  end;

  [JavaSignature('com/google/zxing/common/BitSource')]
  JBitSource = interface(JObject)
    ['{1F842A32-19BF-47C2-A35F-BBB35991EEC8}']
    function available: Integer; cdecl;
    function getBitOffset: Integer; cdecl;
    function getByteOffset: Integer; cdecl;
    function readBits(int: Integer): Integer; cdecl;
  end;
  TJBitSource = class(TJavaGenericImport<JBitSourceClass, JBitSource>) end;

  JCharacterSetECIClass = interface(JEnumClass)
    ['{9064F6E9-05B8-4C8A-B6D5-89D7FF3FAD90}']
    ...
    {class} function getCharacterSetECIByName(string_1: JString): JCharacterSetECI; cdecl;
    {class} function getCharacterSetECIByValue(int: Integer): JCharacterSetECI; cdecl;
    {class} function valueOf(string_1: JString): JCharacterSetECI; cdecl;
  ...
  JCharacterSetECI = interface(JEnum)
    ['{89C987BC-4A23-47D2-A8C3-E82C2D6D84F0}']
  ...
  JDetectorResultClass = interface(JObjectClass)
    ['{F09B987C-A645-4F84-BFA7-062F4162328C}']
    {class} function init(bitMatrix: JBitMatrix; resultPoints: TJavaObjectArray<JResultPoint>): JDetectorResult; cdecl;
  end;

  [JavaSignature('com/google/zxing/common/DetectorResult')]
  JDetectorResult = interface(JObject)
    ['{8088A580-CD96-47C5-9B04-AE84CEABA213}']
  ...
  JECIStringBuilderClass = interface(JObjectClass)
    ['{30374F3A-C55B-4AF6-A26F-5DA70C6D9602}']
    {class} function init(int: Integer): JECIStringBuilder; overload; cdecl;
    {class} function init: JECIStringBuilder; overload; cdecl;
  end;

  [JavaSignature('com/google/zxing/common/ECIStringBuilder')]
  JECIStringBuilder = interface(JObject)
    ['{94D442F2-94B0-4035-AB56-CC97DC47E8E9}']
    procedure append(byte: Byte); overload; cdecl;
    procedure append(string_1: JString); overload; cdecl;
    procedure append(int: Integer); overload; cdecl;
    procedure append(char: Char); overload; cdecl;
    procedure appendCharacters(stringBuilder: JStringBuilder); cdecl;
    procedure appendECI(int: Integer); cdecl;
    function isEmpty: Boolean; cdecl;
    function length: Integer; cdecl;
    function toString: JString; cdecl;
  end;
  TJECIStringBuilder = class(TJavaGenericImport<JECIStringBuilderClass, JECIStringBuilder>) end;

  JStringUtilsClass = interface(JObjectClass)
    ['{000569C0-6BDB-497A-8FAA-9BBA398D951C}']
    ...
    {class} function guessCharset(bytes: TJavaArray<Byte>; map: JMap): JCharset; cdecl;
    {class} function guessEncoding(bytes: TJavaArray<Byte>; map: JMap): JString; cdecl;
  ...
  JStringUtils = interface(JObject)
    ['{E5325733-9592-4B23-8C19-820CB6CA808A}']
  end;
  TJStringUtils = class(TJavaGenericImport<JStringUtilsClass, JStringUtils>) end;

  JMinimalECIInputClass = interface(JObjectClass)
    ['{88571C2C-F45D-4DAC-B1A5-1A848F1C0005}']
    {class} function init(string_1: JString; charset: JCharset; int: Integer): JMinimalECIInput; cdecl;
  end;

  [JavaSignature('com/google/zxing/common/MinimalECIInput')]
  JMinimalECIInput = interface(JObject)
    ['{DC7D86F7-AC60-4DDE-A0EA-F64E9B24EB24}']
    function charAt(int: Integer): Char; cdecl;
    function getECIValue(int: Integer): Integer; cdecl;
    function getFNC1Character: Integer; cdecl;
    function haveNCharacters(int: Integer; int_1: Integer): Boolean; cdecl;
    function isECI(int: Integer): Boolean; cdecl;
    function isFNC1(int: Integer): Boolean; cdecl;
    function length: Integer; cdecl;
    function subSequence(int: Integer; int_1: Integer): JCharSequence; cdecl;
    function toString: JString; cdecl;
  end;
  TJMinimalECIInput = class(TJavaGenericImport<JMinimalECIInputClass, JMinimalECIInput>) end;

  JBitMatrixClass = interface(JObjectClass)
    ['{F393CAF8-9965-4E3A-9E5F-A5DE462CD727}']
    {class} function init(int: Integer; int_1: Integer): JBitMatrix; overload; cdecl;
    {class} function init(int: Integer): JBitMatrix; overload; cdecl;
    {class} function parse(booleanss: TJavaArray<Boolean>): JBitMatrix; overload; cdecl;
    {class} function parse(string_1: JString; string_2: JString; string_3: JString): JBitMatrix; overload; cdecl;
  end;

  [JavaSignature('com/google/zxing/common/BitMatrix')]
  JBitMatrix = interface(JObject)
    ['{B26C57CC-F5E7-4C97-B6DB-11B8D0D7D56A}']
    procedure clear; cdecl;
    function clone: JBitMatrix; overload; cdecl;
    function equals(object_1: JObject): Boolean; cdecl;
    procedure flip(int: Integer; int_1: Integer); overload; cdecl;
    procedure flip; overload; cdecl;
    function get(int: Integer; int_1: Integer): Boolean; cdecl;
    function getBottomRightOnBit: TJavaArray<Integer>; cdecl;
    function getEnclosingRectangle: TJavaArray<Integer>; cdecl;
    function getHeight: Integer; cdecl;
    function getRow(int: Integer; bitArray: JBitArray): JBitArray; cdecl;
    function getRowSize: Integer; cdecl;
    function getTopLeftOnBit: TJavaArray<Integer>; cdecl;
    function getWidth: Integer; cdecl;
    function hashCode: Integer; cdecl;
    procedure rotate(int: Integer); cdecl;
    procedure rotate180; cdecl;
    procedure rotate90; cdecl;
    procedure &set(int: Integer; int_1: Integer); cdecl;
    procedure setRegion(int: Integer; int_1: Integer; int_2: Integer; int_3: Integer); cdecl;
    procedure setRow(int: Integer; bitArray: JBitArray); cdecl;
    function toString(string_1: JString; string_2: JString; string_3: JString): JString; overload; cdecl;
    function toString(string_1: JString; string_2: JString): JString; overload; cdecl;
    function toString: JString; overload; cdecl;
    procedure unset(int: Integer; int_1: Integer); cdecl;
  ...
  JPerspectiveTransformClass = interface(JObjectClass)
    ['{9FDD4145-3B91-4D7B-9F68-F3241572C2E8}']
    {class} function quadrilateralToQuadrilateral(float: Single; float_1: Single; float_2: Single; float_3: Single; float_4: Single; float_5: Single; float_6: Single; float_7: Single; float_8: Single; float_9: Single; float_10: Single; float_11: Single; float_12: Single; float_13: Single; float_14: Single; float_15: Single): JPerspectiveTransform; cdecl;
    {class} function quadrilateralToSquare(float: Single; float_1: Single; float_2: Single; float_3: Single; float_4: Single; float_5: Single; float_6: Single; float_7: Single): JPerspectiveTransform; cdecl;
    {class} function squareToQuadrilateral(float: Single; float_1: Single; float_2: Single; float_3: Single; float_4: Single; float_5: Single; float_6: Single; float_7: Single): JPerspectiveTransform; cdecl;
  end;

  [JavaSignature('com/google/zxing/common/PerspectiveTransform')]
  JPerspectiveTransform = interface(JObject)
    ['{3E18E394-CF1B-44A8-90CC-EC65AD2A5AE9}']
    procedure transformPoints(floats: TJavaArray<Single>; floats_1: TJavaArray<Single>); overload; cdecl;
    procedure transformPoints(floats: TJavaArray<Single>); overload; cdecl;
  end;
  ...
  JDecoderResultClass = interface(JObjectClass)
    ['{42F477AF-89FA-463C-9BC6-5006BA236522}']
    {class} function init(bytes: TJavaArray<Byte>; string_1: JString; list: JList; string_2: JString; int: Integer; int_1: Integer): JDecoderResult; overload; cdecl;
    {class} function init(bytes: TJavaArray<Byte>; string_1: JString; list: JList; string_2: JString; int: Integer): JDecoderResult; overload; cdecl;
    {class} function init(bytes: TJavaArray<Byte>; string_1: JString; list: JList; string_2: JString): JDecoderResult; overload; cdecl;
    {class} function init(bytes: TJavaArray<Byte>; string_1: JString; list: JList; string_2: JString; int: Integer; int_1: Integer; int_2: Integer): JDecoderResult; overload; cdecl;
  end;

  [JavaSignature('com/google/zxing/common/DecoderResult')]
  JDecoderResult = interface(JObject)
    ['{113C2D4A-57DA-4731-BDD0-EA5ADED184B1}']
    ...
    procedure setErasures(integer: JInteger); cdecl;
    procedure setErrorsCorrected(integer: JInteger); cdecl;
    procedure setNumBits(int: Integer); cdecl;
    procedure setOther(object_1: JObject); cdecl;
  end;
  ...
  JECIEncoderSetClass = interface(JObjectClass)
    ['{875399BF-2AE0-4AEE-BA37-220CCC44B5D5}']
    {class} function init(string_1: JString; charset: JCharset; int: Integer): JECIEncoderSet; cdecl;
  end;

  [JavaSignature('com/google/zxing/common/ECIEncoderSet')]
  JECIEncoderSet = interface(JObject)
    ['{6E8E5F29-EC82-47C6-8F08-D05AE624452B}']
    function canEncode(char: Char; int_1: Integer): Boolean; cdecl;
    function encode(char: Char; int_1: Integer): TJavaArray<Byte>; overload; cdecl;
    function encode(string_1: JString; int: Integer): TJavaArray<Byte>; overload; cdecl;
    function getCharset(int: Integer): JCharset; cdecl;
    function getCharsetName(int: Integer): JString; cdecl;
    function getECIValue(int: Integer): Integer; cdecl;
    function getPriorityEncoderIndex: Integer; cdecl;
    function length: Integer; cdecl;
  end;
  TJECIEncoderSet = class(TJavaGenericImport<JECIEncoderSetClass, JECIEncoderSet>) end;

  JReedSolomonDecoderClass = interface(JObjectClass)
    ['{8E2E8311-391B-4616-B533-F39FAA8C6BD2}']
  ...
  JReedSolomonDecoder = interface(JObject)
    ['{ED122940-2014-49AD-A6A1-1B1F70726F6F}']
    procedure decode(ints: TJavaArray<Integer>; int: Integer); cdecl;
    function decodeWithECCount(ints: TJavaArray<Integer>; int: Integer): Integer; cdecl;
  end;
  ...
  JGenericGFClass = interface(JObjectClass)
    ['{71835556-3536-4087-A485-DF3D99529A4C}']
    ...
    {class} function init(int: Integer; int_1: Integer; int_2: Integer): JGenericGF; cdecl;
  ...
  JGenericGF = interface(JObject)
    ['{3B76239F-EE2D-4394-A68B-48E2BAC61CB5}']
  ...
  JReedSolomonEncoderClass = interface(JObjectClass)
    ['{46D95941-D9BE-4213-A5EB-7517DEFB68FA}']
  ...
  JReedSolomonEncoder = interface(JObject)
    ['{D87A8009-8FD4-49E4-9752-A44E602BB4C7}']
    procedure encode(ints: TJavaArray<Integer>; int: Integer); cdecl;
  end;
  ...
  JReedSolomonExceptionClass = interface(JExceptionClass)
    ['{1C72723C-AB3F-4C37-8A71-E5878C090100}']
    {class} function init(string_1: JString): JReedSolomonException; cdecl;
  end;

  [JavaSignature('com/google/zxing/common/reedsolomon/ReedSolomonException')]
  JReedSolomonException = interface(JException)
    ['{C4728B62-F732-4E24-84EB-9B08937A67AF}']
  end;
  ...
  JDimensionClass = interface(JObjectClass)
    ['{DF6DE2FB-5EBB-40BC-81AC-2D16A3D97A73}']
    {class} function init(int: Integer; int_1: Integer): JDimension; cdecl;
  end;

  [JavaSignature('com/google/zxing/Dimension')]
  JDimension = interface(JObject)
    ['{832D5D21-B321-448F-B66B-8130CE9E4039}']
    function equals(object_1: JObject): Boolean; cdecl;
    function getHeight: Integer; cdecl;
    function getWidth: Integer; cdecl;
    function hashCode: Integer; cdecl;
  ...
  JWriterExceptionClass = interface(JExceptionClass)
    ['{EB9336F4-6C69-45F5-AB33-04338A565547}']
    {class} function init(throwable: JThrowable): JWriterException; overload; cdecl;
    {class} function init(string_1: JString): JWriterException; overload; cdecl;
    {class} function init: JWriterException; overload; cdecl;
  end;

  [JavaSignature('com/google/zxing/WriterException')]
  JWriterException = interface(JException)
    ['{812334A9-F8E6-4BE7-94F7-18740E19D39F}']
  end;
  ...
  JMultiFormatReaderClass = interface(JObjectClass)
    ['{515153F1-4766-4A70-9028-F66F907A93DA}']
  ...
  JMultiFormatReader = interface(JObject)
    ['{A751FE2F-0F98-4318-9BB7-E5E353BD2B89}']
    function decode(binaryBitmap: JBinaryBitmap; map: JMap): JResult; overload; cdecl;
    function decode(binaryBitmap: JBinaryBitmap): JResult; overload; cdecl;
    function decodeWithState(binaryBitmap: JBinaryBitmap): JResult; cdecl;
    procedure reset; cdecl;
  ...
  JAztecDetectorResultClass = interface(JDetectorResultClass)
    ['{A54D60E4-21A3-4D1E-B196-D1898FCAADA7}']
    {class} function init(bitMatrix: JBitMatrix; resultPoints: TJavaObjectArray<JResultPoint>; boolean: Boolean; int_1: Integer; int: Integer; int_2: Integer): JAztecDetectorResult; overload; cdecl;
    {class} function init(bitMatrix: JBitMatrix; resultPoints: TJavaObjectArray<JResultPoint>; boolean: Boolean; int_1: Integer; int: Integer): JAztecDetectorResult; overload; cdecl;
  end;

  [JavaSignature('com/google/zxing/aztec/AztecDetectorResult')]
  JAztecDetectorResult = interface(JDetectorResult)
    ['{A9DFE871-9BE0-4CA8-ABDC-9E601A75F857}']
  ...
  Jaztec_detector_DetectorClass = interface(JObjectClass)
    ['{66A1FFB4-7C88-4007-B9CC-7B3EED0AD501}']
  ...
  Jaztec_detector_Detector = interface(JObject)
    ['{AF8B2AF6-91ED-4574-8363-FD4AE1476B85}']
    function detect(boolean: Boolean): JAztecDetectorResult; overload; cdecl;
    function detect: JAztecDetectorResult; overload; cdecl;
  end;
  ...
  JEncoderClass = interface(JObjectClass)
    ['{CFEEF62F-F0F9-4BD1-93BA-91EFF3207DD4}']
    {class} function _GetDEFAULT_AZTEC_LAYERS: Integer; cdecl;
    {class} function _GetDEFAULT_EC_PERCENT: Integer; cdecl;
    {class} function encode(bytes: TJavaArray<Byte>): JAztecCode; overload; cdecl;
    {class} function encode(bytes: TJavaArray<Byte>; int: Integer; int_1: Integer): JAztecCode; overload; cdecl;
    {class} function encode(bytes: TJavaArray<Byte>; int: Integer; int_1: Integer; charset: JCharset): JAztecCode; overload; cdecl;
    {class} function encode(string_1: JString): JAztecCode; overload; cdecl;
    {class} function encode(string_1: JString; int: Integer; int_1: Integer): JAztecCode; overload; cdecl;
    {class} function encode(string_1: JString; int: Integer; int_1: Integer; charset: JCharset): JAztecCode; overload; cdecl;
  ...
  JEncoder = interface(JObject)
    ['{7B81CCCF-81DE-448D-9332-8148B9D54BC5}']
  end;
  TJEncoder = class(TJavaGenericImport<JEncoderClass, JEncoder>) end;

  Jencoder_HighLevelEncoderClass = interface(JObjectClass)
    ['{962ADBA9-2390-49D2-B753-5FD365E4D755}']
    {class} function init(bytes: TJavaArray<Byte>; charset: JCharset): Jencoder_HighLevelEncoder; overload; cdecl;
    {class} function init(bytes: TJavaArray<Byte>): Jencoder_HighLevelEncoder; overload; cdecl;
  end;

  [JavaSignature('com/google/zxing/aztec/encoder/HighLevelEncoder')]
  Jencoder_HighLevelEncoder = interface(JObject)
    ['{AE4F8B7F-E58B-44AD-9B17-0AB7EF1B9EAF}']
  ...
  Jaztec_decoder_Decoder = interface(JObject)
    ['{B6BFAC21-94D4-4869-BB20-B5FCA77029D3}']
  ...
  JReaderClass = interface(IJavaClass)
    ['{C1C17FFE-FA02-4984-B7EE-E072072A73F6}']
  end;

  [JavaSignature('com/google/zxing/Reader')]
  JReader = interface(IJavaInstance)
    ['{42A06AA5-BDBA-49D9-8603-5B25A3C9A0A5}']
    function decode(binaryBitmap: JBinaryBitmap; map: JMap): JResult; overload; cdecl;
    function decode(binaryBitmap: JBinaryBitmap): JResult; overload; cdecl;
    procedure reset; cdecl;
  end;
  ...
  JParsedResultClass = interface(JObjectClass)
    ['{50329CB9-A6C2-466F-BB08-517F7252302B}']
    {class} procedure maybeAppend(string_1: JString; stringBuilder: JStringBuilder); overload; cdecl;
    {class} procedure maybeAppend(strings: TJavaObjectArray<JString>; stringBuilder: JStringBuilder); overload; cdecl;
  end;

  [JavaSignature('com/google/zxing/client/result/ParsedResult')]
  JParsedResult = interface(JObject)
    ['{A1AB997A-60D0-4E60-94AA-D4378B03C0B2}']
  ...
  JParsedResultTypeClass = interface(JEnumClass)
    ['{30C7CA57-C3D5-43AC-AABE-F4BF1C028F80}']
    ...
    {class} function valueOf(string_1: JString): JParsedResultType; cdecl;
  ...
  JParsedResultType = interface(JEnum)
    ['{39D62627-383A-4447-8408-B7E0F5094192}']
  end;
  ...
  JWifiParsedResultClass = interface(JParsedResultClass)
    ['{6DB26C4E-C578-4490-8293-CAFBCB4DB5EA}']
    {class} function init(string_1: JString; string_2: JString; string_3: JString): JWifiParsedResult; overload; cdecl;
    {class} function init(string_1: JString; string_2: JString; string_3: JString; boolean: Boolean): JWifiParsedResult; overload; cdecl;
    {class} function init(string_1: JString; string_2: JString; string_3: JString; boolean: Boolean; string_4: JString; string_5: JString; string_6: JString; string_7: JString): JWifiParsedResult; overload; cdecl;
  end;

  [JavaSignature('com/google/zxing/client/result/WifiParsedResult')]
  JWifiParsedResult = interface(JParsedResult)
    ['{55C64E7E-A14F-4D4A-9338-4A4557D22014}']
  ...
  JExpandedProductParsedResult = interface(JParsedResult)
    ['{300E481C-9232-4C55-A1BD-97A1872A86EE}']
    function equals(object_1: JObject): Boolean; cdecl;
  ...
  JTextParsedResultClass = interface(JParsedResultClass)
    ['{43D8425A-6A5A-4836-BDE1-99FF481CE86B}']
    {class} function init(string_1: JString; string_2: JString): JTextParsedResult; cdecl;
  end;

  [JavaSignature('com/google/zxing/client/result/TextParsedResult')]
  JTextParsedResult = interface(JParsedResult)
    ['{56225CC6-32AC-42B7-BEFB-8CB038EDDD92}']
    function getDisplayResult: JString; cdecl;
  ...
  JSMSParsedResultClass = interface(JParsedResultClass)
    ['{7B30B744-9086-4CD9-8416-D729E1DE864B}']
    {class} function init(string_1: JString; string_2: JString; string_3: JString; string_4: JString): JSMSParsedResult; overload; cdecl;
    {class} function init(strings: TJavaObjectArray<JString>; strings_1: TJavaObjectArray<JString>; string_1: JString; string_2: JString): JSMSParsedResult; overload; cdecl;
  end;

  [JavaSignature('com/google/zxing/client/result/SMSParsedResult')]
  JSMSParsedResult = interface(JParsedResult)
    ['{893F84D9-55F5-4BB1-9A3F-12E4F6347184}']
  ...
  JURIParsedResultClass = interface(JParsedResultClass)
    ['{BB979F88-B9DB-4ACE-ABCC-F00135BAD49D}']
    {class} function init(string_1: JString; string_2: JString): JURIParsedResult; cdecl;
  end;

  [JavaSignature('com/google/zxing/client/result/URIParsedResult')]
  JURIParsedResult = interface(JParsedResult)
    ['{4A87D40C-AFBE-4F59-9DFE-42B97A7B37AA}']
    function getDisplayResult: JString; cdecl;
  ...
  JVINParsedResultClass = interface(JParsedResultClass)
    ['{2A4256F0-1FBD-4C9C-B077-56C3CD0382B9}']
    {class} function init(string_1: JString; string_2: JString; string_3: JString; string_4: JString; string_5: JString; string_6: JString; int: Integer; char: Char; string_7: JString): JVINParsedResult; cdecl;
  end;

  [JavaSignature('com/google/zxing/client/result/VINParsedResult')]
  JVINParsedResult = interface(JParsedResult)
    ['{E5C017F4-5513-49F5-9D0A-4D52ECC18FFA}']
  ...
  JBinaryBitmap = interface(JObject)
    ['{B2DBF580-A0DC-4B78-AE97-53637EB2E7BB}']
    function crop(int: Integer; int_1: Integer; int_2: Integer; int_3: Integer): JBinaryBitmap; cdecl;
    function getBlackMatrix: JBitMatrix; cdecl;
    function getBlackRow(int: Integer; bitArray: JBitArray): JBitArray; cdecl;
    function getHeight: Integer; cdecl;
    function getWidth: Integer; cdecl;
  ...
  JWriterClass = interface(IJavaClass)
    ['{51B6FCAB-1934-44A2-A2E0-526BC013364C}']
  end;

  [JavaSignature('com/google/zxing/Writer')]
  JWriter = interface(IJavaInstance)
    ['{2263B0A2-4F33-480A-8445-C04B25AE852E}']
    function encode(string_1: JString; barcodeFormat: JBarcodeFormat; int: Integer; int_1: Integer): JBitMatrix; overload; cdecl;
    function encode(string_1: JString; barcodeFormat: JBarcodeFormat; int: Integer; int_1: Integer; map: JMap): JBitMatrix; overload; cdecl;
  end;
  ...
  JBarcodeFormatClass = interface(JEnumClass)
    ['{5A94A93E-5EDF-4B39-8C6F-94C610AB8152}']
    ...
    {class} function valueOf(string_1: JString): JBarcodeFormat; cdecl;
  ...
  JBarcodeFormat = interface(JEnum)
    ['{2FEB62AF-D90B-428A-BABF-45855159C03E}']
  end;
  ...
  JNotFoundExceptionClass = interface(JReaderExceptionClass)
    ['{22B6A065-8C6E-42D8-BC44-31DD8A83C9C5}']
  ...
  JNotFoundException = interface(JReaderException)
    ['{580C7C37-76C2-4CC0-B5BA-EB5626A9F0E4}']
  end;
  ...
  JLuminanceSourceClass = interface(JObjectClass)
    ['{310E5CF5-0BF0-458A-8A3C-6E63615B11AE}']
  end;

  [JavaSignature('com/google/zxing/LuminanceSource')]
  JLuminanceSource = interface(JObject)
    ['{6E185322-E769-4EE7-ADCD-CCC81C8458E4}']
    function crop(int: Integer; int_1: Integer; int_2: Integer; int_3: Integer): JLuminanceSource; cdecl;
    function getHeight: Integer; cdecl;
    function getMatrix: TJavaArray<Byte>; cdecl;
    function getRow(int: Integer; bytes: TJavaArray<Byte>): TJavaArray<Byte>; cdecl;
    function getWidth: Integer; cdecl;
  ...
  JFormatExceptionClass = interface(JReaderExceptionClass)
    ['{D8F378F7-D848-45DE-B8DA-B58F9F9E58E7}']
    {class} function getFormatInstance: JFormatException; overload; cdecl;
    {class} function getFormatInstance(throwable: JThrowable): JFormatException; overload; cdecl;
  end;

  [JavaSignature('com/google/zxing/FormatException')]
  JFormatException = interface(JReaderException)
    ['{11CBFD4C-85C5-4AC1-96D9-B246961EB0E6}']
  end;
  TJFormatException = class(TJavaGenericImport<JFormatExceptionClass, JFormatException>) end;

  Jdatamatrix_detector_DetectorClass = interface(JObjectClass)
    ['{7EC6EB36-A428-457D-87A7-D7109781439E}']
    {class} function init(bitMatrix: JBitMatrix): Jdatamatrix_detector_Detector; cdecl;
  end;

  [JavaSignature('com/google/zxing/datamatrix/detector/Detector')]
  Jdatamatrix_detector_Detector = interface(JObject)
    ['{C491B68A-104C-40BC-A64B-31D4F2C427BC}']
    function detect: JDetectorResult; cdecl;
  end;
  TJdatamatrix_detector_Detector = class(TJavaGenericImport<Jdatamatrix_detector_DetectorClass, Jdatamatrix_detector_Detector>) end;

  JDataMatrixReaderClass = interface(JObjectClass)
    ['{6A5998E0-2207-4007-A8D4-635E16834183}']
    {class} function init: JDataMatrixReader; cdecl;
  end;

  [JavaSignature('com/google/zxing/datamatrix/DataMatrixReader')]
  JDataMatrixReader = interface(JObject)
    ['{9AB844BB-A960-442D-BB24-5707FC3ACC4E}']
    function decode(binaryBitmap: JBinaryBitmap; map: JMap): JResult; overload; cdecl;
    function decode(binaryBitmap: JBinaryBitmap): JResult; overload; cdecl;
    procedure reset; cdecl;
  end;
  ...
  JDataMatrixWriterClass = interface(JObjectClass)
    ['{E49CAC6F-BD95-4A05-A0FF-1A83808370D9}']
  ...
  JDataMatrixWriter = interface(JObject)
    ['{21DCEFBD-7799-4831-960F-4A01B01F263F}']
    function encode(string_1: JString; barcodeFormat: JBarcodeFormat; int: Integer; int_1: Integer; map: JMap): JBitMatrix; overload; cdecl;
    function encode(string_1: JString; barcodeFormat: JBarcodeFormat; int: Integer; int_1: Integer): JBitMatrix; overload; cdecl;
  end;
  ...
  JMinimalEncoderClass = interface(JObjectClass)
    ['{8F92D14D-FB47-4C82-8859-D84F074A117B}']
    {class} function encodeHighLevel(string_1: JString): JString; overload; cdecl;
    {class} function encodeHighLevel(string_1: JString; charset: JCharset; int: Integer; symbolShapeHint: JSymbolShapeHint): JString; overload; cdecl;
  end;

  [JavaSignature('com/google/zxing/datamatrix/encoder/MinimalEncoder')]
  JMinimalEncoder = interface(JObject)
    ['{834DD00B-8573-4F86-AA87-FBC40F38FBBA}']
  end;
  TJMinimalEncoder = class(TJavaGenericImport<JMinimalEncoderClass, JMinimalEncoder>) end;

  JHighLevelEncoderClass = interface(JObjectClass)
    ['{6E85102A-2F21-424A-A678-3A58F8297827}']
    {class} function determineConsecutiveDigitCount(charSequence: JCharSequence; int: Integer): Integer; cdecl;
    {class} function encodeHighLevel(string_1: JString; symbolShapeHint: JSymbolShapeHint; dimension: JDimension; dimension_1: JDimension; boolean: Boolean): JString; overload; cdecl;
    {class} function encodeHighLevel(string_1: JString; symbolShapeHint: JSymbolShapeHint; dimension: JDimension; dimension_1: JDimension): JString; overload; cdecl;
    {class} function encodeHighLevel(string_1: JString): JString; overload; cdecl;
  end;

  [JavaSignature('com/google/zxing/datamatrix/encoder/HighLevelEncoder')]
  JHighLevelEncoder = interface(JObject)
    ['{A3EFA682-C338-49AC-82D7-A5F217A2ECA7}']
  end;
  ...
  Jencoder_ErrorCorrectionClass = interface(JObjectClass)
    ['{841F76C9-51BA-44A1-8427-804638AFF445}']
    {class} function encodeECC200(string_1: JString; symbolInfo: JSymbolInfo): JString; cdecl;
  end;

  [JavaSignature('com/google/zxing/datamatrix/encoder/ErrorCorrection')]
  Jencoder_ErrorCorrection = interface(JObject)
    ['{66D1B56D-91AE-402F-A303-211070CEF552}']
  end;
  ...
  JSymbolShapeHintClass = interface(JEnumClass)
    ['{E959D8C0-FD5C-4C81-A03D-E508ED3C63B3}']
    ...
    {class} function valueOf(string_1: JString): JSymbolShapeHint; cdecl;
  ...
  JSymbolShapeHint = interface(JEnum)
    ['{85E398D2-DCB7-475B-996B-21472DB7C5FF}']
  end;
  ...
  JSymbolInfoClass = interface(JObjectClass)
    ['{A12BD536-FEA6-4908-A7BC-47E12C4459F2}']
    {class} function init(boolean: Boolean; int_1: Integer; int: Integer; int_2: Integer; int_3: Integer; int_4: Integer): JSymbolInfo; cdecl;
    {class} function lookup(int: Integer): JSymbolInfo; overload; cdecl;
    {class} function lookup(int: Integer; symbolShapeHint: JSymbolShapeHint): JSymbolInfo; overload; cdecl;
    {class} function lookup(int: Integer; symbolShapeHint: JSymbolShapeHint; dimension: JDimension; dimension_1: JDimension; boolean: Boolean): JSymbolInfo; overload; cdecl;
    {class} function lookup(int: Integer; boolean: Boolean; boolean_1: Boolean): JSymbolInfo; overload; cdecl;
    {class} procedure overrideSymbolSet(symbolInfos: TJavaObjectArray<JSymbolInfo>); cdecl;
  end;

  [JavaSignature('com/google/zxing/datamatrix/encoder/SymbolInfo')]
  JSymbolInfo = interface(JObject)
    ['{4D81649A-2B00-4B75-8044-38FD75291D6E}']
    ...
    function getDataLengthForInterleavedBlock(int: Integer): Integer; cdecl;
    function getErrorCodewords: Integer; cdecl;
    function getErrorLengthForInterleavedBlock(int: Integer): Integer; cdecl;
  ...
  JDefaultPlacementClass = interface(JObjectClass)
    ['{240B06A8-FBB1-4F2E-85A9-DDE7DB9F4201}']
    {class} function init(charSequence: JCharSequence; int: Integer; int_1: Integer): JDefaultPlacement; cdecl;
  end;

  [JavaSignature('com/google/zxing/datamatrix/encoder/DefaultPlacement')]
  JDefaultPlacement = interface(JObject)
    ['{C751F2AF-6370-426E-8F8A-896E841B0C7B}']
    function getBit(int: Integer; int_1: Integer): Boolean; cdecl;
  ...
  JDecoderClass = interface(JObjectClass)
    ['{B59BC0F6-4AB6-4C39-B42D-2BB8B182FA56}']
    {class} function init: JDecoder; cdecl;
  end;

  [JavaSignature('com/google/zxing/datamatrix/decoder/Decoder')]
  JDecoder = interface(JObject)
    ['{9AEF0B9F-E4E9-4D61-B859-07F4D43C62DF}']
    function decode(bitMatrix: JBitMatrix): JDecoderResult; overload; cdecl;
    function decode(booleanss: TJavaArray<Boolean>): JDecoderResult; overload; cdecl;
  end;
  ...
  JVersionClass = interface(JObjectClass)
    ['{3A4D4E5C-508B-400E-8BB2-6BB209DDA623}']
    {class} function getVersionForDimensions(int: Integer; int_1: Integer): JVersion; cdecl;
  end;

  [JavaSignature('com/google/zxing/datamatrix/decoder/Version')]
  JVersion = interface(JObject)
    ['{25E2684E-702D-4778-BE94-6BC6EFE2C34D}']
  ...
  JEncodeHintTypeClass = interface(JEnumClass)
    ['{21372BAC-4BD6-4779-B624-18E004CD56DD}']
    ...
    {class} function valueOf(string_1: JString): JEncodeHintType; cdecl;
  ...
  JEncodeHintType = interface(JEnum)
    ['{4242E7CB-D1B8-4FE5-A09A-DF5EE77DF89C}']
  end;
  ...
  JRSSUtilsClass = interface(JObjectClass)
    ['{EF3FD91A-CC99-47F8-8D4D-A1D7E6D5AB0E}']
    {class} function getRSSvalue(ints: TJavaArray<Integer>; int: Integer; boolean: Boolean): Integer; cdecl;
  end;

  [JavaSignature('com/google/zxing/oned/rss/RSSUtils')]
  JRSSUtils = interface(JObject)
    ['{82CE2BD8-C86C-4827-A3E1-47E4A376F740}']
  end;
  TJRSSUtils = class(TJavaGenericImport<JRSSUtilsClass, JRSSUtils>) end;

  JFinderPatternClass = interface(JObjectClass)
    ['{CCBAA00D-8FBD-44FE-B6E8-CCDB997CFF15}']
    {class} function init(int: Integer; ints: TJavaArray<Integer>; int_1: Integer; int_2: Integer; int_3: Integer): JFinderPattern; cdecl;
  end;

  [JavaSignature('com/google/zxing/oned/rss/FinderPattern')]
  JFinderPattern = interface(JObject)
    ['{A5D7F1B2-625F-4A7A-BD19-BBC767554BB9}']
    function equals(object_1: JObject): Boolean; cdecl;
    function getResultPoints: TJavaObjectArray<JResultPoint>; cdecl;
  ...
  JAbstractExpandedDecoderClass = interface(JObjectClass)
    ['{DE74E863-BA97-4217-81CE-A69D438C0A6C}']
  ...
  JAbstractExpandedDecoder = interface(JObject)
    ['{7855DBBC-2A58-48E6-BD6E-E6662E88A042}']
  ...
  JDataCharacterClass = interface(JObjectClass)
    ['{ABF7A6DC-A366-402B-AFDF-007E9DE3FA0D}']
    {class} function init(int: Integer; int_1: Integer): JDataCharacter; cdecl;
  end;

  [JavaSignature('com/google/zxing/oned/rss/DataCharacter')]
  JDataCharacter = interface(JObject)
    ['{372C990A-0D69-47B6-BC5B-9858120DA777}']
    function equals(object_1: JObject): Boolean; cdecl;
  ...
  JOneDimensionalCodeWriterClass = interface(JObjectClass)
    ['{6F613B77-9CCA-496B-AD18-8C9454DCAEE8}']
    {class} function init: JOneDimensionalCodeWriter; cdecl;
  end;

  [JavaSignature('com/google/zxing/oned/OneDimensionalCodeWriter')]
  JOneDimensionalCodeWriter = interface(JObject)
    ['{BBA3C9AB-E3E4-474E-9470-B922AB2EC9B5}']
    function encode(string_1: JString; barcodeFormat: JBarcodeFormat; int: Integer; int_1: Integer; map: JMap): JBitMatrix; overload; cdecl;
    function encode(string_1: JString; barcodeFormat: JBarcodeFormat; int: Integer; int_1: Integer): JBitMatrix; overload; cdecl;
    function encode(string_1: JString; map: JMap): TJavaArray<Boolean>; overload; cdecl;
    function encode(string_1: JString): TJavaArray<Boolean>; overload; cdecl;
  ...
  JITFWriterClass = interface(JOneDimensionalCodeWriterClass)
    ['{749CE46A-A16C-4252-8EB2-41E7E8E5E9C5}']
  ...
  JITFWriter = interface(JOneDimensionalCodeWriter)
    ['{4A7E04F7-F928-42AB-A61A-AEB5231B53CA}']
    function encode(string_1: JString): TJavaArray<Boolean>; cdecl;
  end;
  ...
  JCodaBarWriterClass = interface(JOneDimensionalCodeWriterClass)
    ['{989C145F-B781-42AA-83D9-BDA5EC963AE4}']
  ...
  JCodaBarWriter = interface(JOneDimensionalCodeWriter)
    ['{FCC04A29-1BBF-4DA0-8827-B9A349B52452}']
    function encode(string_1: JString): TJavaArray<Boolean>; cdecl;
  end;
  ...
  JCode128WriterClass = interface(JOneDimensionalCodeWriterClass)
    ['{A094424E-8520-4AEF-AB9B-95A362AC2414}']
  ...
  JCode128Writer = interface(JOneDimensionalCodeWriter)
    ['{D4BCA800-5516-4A13-BDD9-D51E0D6E29DA}']
    function encode(string_1: JString; map: JMap): TJavaArray<Boolean>; overload; cdecl;
    function encode(string_1: JString): TJavaArray<Boolean>; overload; cdecl;
  end;
  ...
  JPDF417CommonClass = interface(JObjectClass)
    ...
    {class} function getBitCountSum(ints: TJavaArray<Integer>): Integer; cdecl;
    {class} function getCodeword(int: Integer): Integer; cdecl;
  ...
  JDetectorClass = interface(JObjectClass)
    ['{7AC0E66F-EA9F-496E-A8A8-12B3B05FA4A5}']
    {class} function detect(binaryBitmap: JBinaryBitmap; map: JMap; boolean: Boolean): JPDF417DetectorResult; cdecl;
  end;

  [JavaSignature('com/google/zxing/pdf417/detector/Detector')]
  JDetector = interface(JObject)
    ['{E88C8109-5C2D-41DE-94AE-12E5E9E7D1C7}']
  end;
  TJDetector = class(TJavaGenericImport<JDetectorClass, JDetector>) end;

  JPDF417DetectorResultClass = interface(JObjectClass)
    ['{F1859FDF-5987-4FA8-A083-C353440D2030}']
    {class} function init(bitMatrix: JBitMatrix; list: JList; int: Integer): JPDF417DetectorResult; overload; cdecl;
    {class} function init(bitMatrix: JBitMatrix; list: JList): JPDF417DetectorResult; overload; cdecl;
  end;

  [JavaSignature('com/google/zxing/pdf417/detector/PDF417DetectorResult')]
  JPDF417DetectorResult = interface(JObject)
    ['{E6E2D7C7-81DB-4BA4-AD79-31B0A4536DAA}']
    function getBits: JBitMatrix; cdecl;
  ...
  JPDF417ResultMetadataClass = interface(JObjectClass)
    ['{1F20EE83-2E59-473C-84FB-D4CBB8AE78FE}']
  ...
  JPDF417ResultMetadata = interface(JObject)
    ['{B0433355-E42A-432A-8496-3B3BE7461D5B}']
    ...
    procedure setAddressee(string_1: JString); cdecl;
    procedure setChecksum(int: Integer); cdecl;
    procedure setFileId(string_1: JString); cdecl;
    procedure setFileName(string_1: JString); cdecl;
    procedure setFileSize(long: Int64); cdecl;
    procedure setLastSegment(boolean: Boolean); cdecl;
    procedure setOptionalData(ints: TJavaArray<Integer>); cdecl;
    procedure setSegmentCount(int: Integer); cdecl;
    procedure setSegmentIndex(int: Integer); cdecl;
    procedure setSender(string_1: JString); cdecl;
    procedure setTimestamp(long: Int64); cdecl;
  end;
  ...
  JCompactionClass = interface(JEnumClass)
    ['{64FF3235-145A-4000-9A1E-9D188F36F379}']
    ...
    {class} function valueOf(string_1: JString): JCompaction; cdecl;
  ...
  JCompaction = interface(JEnum)
    ['{BCD42995-4282-49A9-AABC-BF90D9F4D030}']
  end;
  TJCompaction = class(TJavaGenericImport<JCompactionClass, JCompaction>) end;

  JPDF417Class = interface(JObjectClass)
    ['{5FC0F80E-D20A-426B-924C-82A7271AFC65}']
    {class} function init: JPDF417; overload; cdecl;
    {class} function init(boolean: Boolean): JPDF417; overload; cdecl;
  end;

  [JavaSignature('com/google/zxing/pdf417/encoder/PDF417')]
  JPDF417 = interface(JObject)
    ['{5996D191-E404-4809-B3BE-F59EB49B9C25}']
    procedure generateBarcodeLogic(string_1: JString; int: Integer; boolean: Boolean); overload; cdecl;
    procedure generateBarcodeLogic(string_1: JString; int: Integer); overload; cdecl;
    function getBarcodeMatrix: JBarcodeMatrix; cdecl;
    procedure setCompact(boolean: Boolean); cdecl;
    procedure setCompaction(compaction: JCompaction); cdecl;
    procedure setDimensions(int: Integer; int_1: Integer; int_2: Integer; int_3: Integer); cdecl;
  ...
  JDimensionsClass = interface(JObjectClass)
    ['{A7278006-7676-4BD0-961A-7A1B138CDE69}']
    {class} function init(int: Integer; int_1: Integer; int_2: Integer; int_3: Integer): JDimensions; cdecl;
  end;

  [JavaSignature('com/google/zxing/pdf417/encoder/Dimensions')]
  JDimensions = interface(JObject)
    ['{C6325D09-8C0A-4536-81A9-955974BBD2EE}']
  ...
  JPDF417HighLevelEncoderTestAdapterClass = interface(JObjectClass)
    ['{83880375-5368-41EE-ABC1-1F94381F0E30}']
    {class} function encodeHighLevel(string_1: JString; compaction: JCompaction; charset: JCharset; boolean: Boolean): JString; cdecl;
  end;
  ...
  JPDF417HighLevelEncoderTestAdapter = interface(JObject)
    ['{2707862B-60AA-4AB0-BDF6-FC893431B7F3}']
  end;
  TJPDF417HighLevelEncoderTestAdapter = class(TJavaGenericImport<JPDF417HighLevelEncoderTestAdapterClass, JPDF417HighLevelEncoderTestAdapter>) end;

  JBarcodeMatrixClass = interface(JObjectClass)
    ['{9CA675D5-50DD-40BF-81C7-26F51EF52C42}']
  end;

  [JavaSignature('com/google/zxing/pdf417/encoder/BarcodeMatrix')]
  JBarcodeMatrix = interface(JObject)
    ['{5FBAA4F8-74EA-48CD-8FC9-70D2798408A9}']
    function getMatrix: TJavaArray<Byte>; cdecl;
    function getScaledMatrix(int: Integer; int_1: Integer): TJavaArray<Byte>; cdecl;
  end;
  ...
  JErrorCorrectionClass = interface(JObjectClass)
    ['{F33F4011-BA22-4D66-AC35-B46217D69EAC}']
  ...
  JErrorCorrection = interface(JObject)
    ['{3DC33EC8-06EB-402A-9AD1-E4AAF1C71953}']
    function decode(ints: TJavaArray<Integer>; int: Integer; ints_1: TJavaArray<Integer>): Integer; cdecl;
  end;
  ...
  JModulusGFClass = interface(JObjectClass)
    ['{1CF736BE-2C1F-4271-8A30-CEF06AB8BA3E}']
  ...
  JPDF417ScanningDecoderClass = interface(JObjectClass)
    ['{ED089C1F-2AD9-43D0-94BD-FA5D8C0E5E10}']
    {class} function decode(bitMatrix: JBitMatrix; resultPoint: JResultPoint; resultPoint_1: JResultPoint; resultPoint_2: JResultPoint; resultPoint_3: JResultPoint; int: Integer; int_1: Integer): JDecoderResult; cdecl;
    {class} function toString(barcodeValuess: TJavaObjectArray<JBarcodeValue>): JString; cdecl;
  end;

  [JavaSignature('com/google/zxing/pdf417/decoder/PDF417ScanningDecoder')]
  JPDF417ScanningDecoder = interface(JObject)
    ['{1DD7E799-FD80-47BB-A82A-8127947A61FF}']
  end;
  ...
  JMultiFinderPatternFinderClass = interface(JFinderPatternFinderClass)
    ['{4688F5B7-4AFF-4A6F-B756-56EFE5F20E3A}']
  ...
  JMultiFinderPatternFinder = interface(JFinderPatternFinder)
    ['{072A8C34-23C7-4895-95B5-EAA24210353B}']
  ...
  JMultiDetectorClass = interface(Jdetector_DetectorClass)
    ['{650BB298-6A48-4DC8-961F-B51969F42CE6}']
  ...
  JMultiDetector = interface(Jdetector_Detector)
    ['{E8633E23-8380-47AF-8354-7FF0A1B137B0}']
  ...
  JQRCodeMultiReaderClass = interface(JQRCodeReaderClass)
    ['{45685E4D-780F-44B0-8289-00422EC0C7E9}']
    {class} function init: JQRCodeMultiReader; cdecl;
  end;

  [JavaSignature('com/google/zxing/multi/qrcode/QRCodeMultiReader')]
  JQRCodeMultiReader = interface(JQRCodeReader)
    ['{5E5A4D69-413B-42A9-A05F-4F901B4D2725}']
    function decodeMultiple(binaryBitmap: JBinaryBitmap; map: JMap): TJavaObjectArray<JResult>; overload; cdecl;
    function decodeMultiple(binaryBitmap: JBinaryBitmap): TJavaObjectArray<JResult>; overload; cdecl;
  end;
  ...
  JChecksumExceptionClass = interface(JReaderExceptionClass)
    ['{D3701569-3544-420C-AFB3-6A06B6509361}']
    {class} function getChecksumInstance: JChecksumException; overload; cdecl;
    {class} function getChecksumInstance(throwable: JThrowable): JChecksumException; overload; cdecl;
  end;

  [JavaSignature('com/google/zxing/ChecksumException')]
  JChecksumException = interface(JReaderException)
    ['{2935BCAA-C614-48D7-BB20-9FAE3CD2BE3C}']
  end;
  TJChecksumException = class(TJavaGenericImport<JChecksumExceptionClass, JChecksumException>) end;

  Jdetector_FinderPatternClass = interface(JResultPointClass)
    ['{156DA537-F735-4DE3-9011-EFA1BE66C1D3}']
  end;

  [JavaSignature('com/google/zxing/qrcode/detector/FinderPattern')]
  Jdetector_FinderPattern = interface(JResultPoint)
    ['{5054A4C6-06A2-4127-9CA6-4AA9CAA762C6}']
    function getCount: Integer; cdecl;
    function getEstimatedModuleSize: Single; cdecl;
  end;
  TJdetector_FinderPattern = class(TJavaGenericImport<Jdetector_FinderPatternClass, Jdetector_FinderPattern>) end;

  JAlignmentPatternClass = interface(JResultPointClass)
    ['{243D78FC-337B-4ACE-BAAE-F56B62B29EA1}']
  end;

  [JavaSignature('com/google/zxing/qrcode/detector/AlignmentPattern')]
  JAlignmentPattern = interface(JResultPoint)
    ['{4412CCB5-22ED-4943-A939-8594B6DBDCEA}']
  end;
  ...
  JDefaultGridSamplerClass = interface(JGridSamplerClass)
    ['{DB0CC4F0-95D4-45C4-8C86-75AFB4FF389D}']
  ...
  JDefaultGridSampler = interface(JGridSampler)
    ['{9B5832CD-F32C-4FA0-98A6-282E50872FBC}']
    function sampleGrid(bitMatrix: JBitMatrix; int: Integer; int_1: Integer; perspectiveTransform: JPerspectiveTransform): JBitMatrix; overload; cdecl;
    function sampleGrid(bitMatrix: JBitMatrix; int: Integer; int_1: Integer; float: Single; float_1: Single; float_2: Single; float_3: Single; float_4: Single; float_5: Single; float_6: Single; float_7: Single; float_8: Single; float_9: Single; float_10: Single; float_11: Single; float_12: Single; float_13: Single; float_14: Single; float_15: Single): JBitMatrix; overload; cdecl;
  end;
  ...
  JGlobalHistogramBinarizerClass = interface(JBinarizerClass)
    ['{602E11F5-84E8-4449-ACCC-C3BCE16876A6}']
  ...
  JGlobalHistogramBinarizer = interface(JBinarizer)
    ['{F9E26A3B-7589-4EE8-97B1-2F9DBC0D5458}']
    function createBinarizer(luminanceSource: JLuminanceSource): JBinarizer; cdecl;
    function getBlackMatrix: JBitMatrix; cdecl;
    function getBlackRow(int: Integer; bitArray: JBitArray): JBitArray; cdecl;
  end;
  ...
  JPlanarYUVLuminanceSourceClass = interface(JLuminanceSourceClass)
    ['{73C8856F-B3D4-4864-9BCB-6C40A4BA944C}']
    {class} function init(bytes: TJavaArray<Byte>; int: Integer; int_1: Integer; int_2: Integer; int_3: Integer; int_4: Integer; int_5: Integer; boolean: Boolean): JPlanarYUVLuminanceSource; cdecl;
  end;

  [JavaSignature('com/google/zxing/PlanarYUVLuminanceSource')]
  JPlanarYUVLuminanceSource = interface(JLuminanceSource)
    ['{C00DCE51-D2A0-4289-A5B0-604495E77D37}']
    function crop(int: Integer; int_1: Integer; int_2: Integer; int_3: Integer): JLuminanceSource; cdecl;
    function getMatrix: TJavaArray<Byte>; cdecl;
    function getRow(int: Integer; bytes: TJavaArray<Byte>): TJavaArray<Byte>; cdecl;
  ...
  JRGBLuminanceSourceClass = interface(JLuminanceSourceClass)
    ['{244B2871-E576-4817-AAD9-410C960F3404}']
    {class} function init(int: Integer; int_1: Integer; ints: TJavaArray<Integer>): JRGBLuminanceSource; cdecl;
  end;

  [JavaSignature('com/google/zxing/RGBLuminanceSource')]
  JRGBLuminanceSource = interface(JLuminanceSource)
    ['{82E4E76B-E3AA-415D-BFBD-18FAF98DFBFC}']
    function crop(int: Integer; int_1: Integer; int_2: Integer; int_3: Integer): JLuminanceSource; cdecl;
    function getMatrix: TJavaArray<Byte>; cdecl;
    function getRow(int: Integer; bytes: TJavaArray<Byte>): TJavaArray<Byte>; cdecl;
    function isCropSupported: Boolean; cdecl;
  ...
  JExpandedProductResultParserClass = interface(JResultParserClass)
    ['{43DCC73A-3C6A-4A50-B1AD-E034C7259D0C}']
  ...
  JExpandedProductResultParser = interface(JResultParser)
    ['{2B93F4B1-777D-460F-B03A-430517994C7B}']
    function parse(result: JResult): JExpandedProductParsedResult; overload; cdecl;
  end;
  ...
  JAbstractDoCoMoResultParserClass = interface(JResultParserClass)
    ['{49A4F6E4-BB2B-4AD0-8E33-C9AD614B8CF2}']
  end;
  ...
  JAbstractDoCoMoResultParser = interface(JResultParser)
    ['{71BA53B6-F094-4DE9-A6EE-CBEFE85F51AB}']
  end;
  ...
  JAddressBookAUResultParserClass = interface(JResultParserClass)
    ['{8178A260-91F7-4DE3-B870-975D01245043}']
  ...
  JAddressBookAUResultParser = interface(JResultParser)
    ['{58022AC7-8B02-4521-B16F-0DBD1E889513}']
    function parse(result: JResult): JAddressBookParsedResult; overload; cdecl;
  end;
  ...
  JBizcardResultParserClass = interface(JAbstractDoCoMoResultParserClass)
    ['{0A98E3AE-8701-44BA-8095-20AFBF85BC46}']
  ...
  JBizcardResultParser = interface(JAbstractDoCoMoResultParser)
    ['{45F6FD5A-4806-4C1A-9788-B772F7CDD02A}']
    function parse(result: JResult): JAddressBookParsedResult; overload; cdecl;
  end;
  ...
  JCalendarParsedResultClass = interface(JParsedResultClass)
    ['{4991497B-EE23-47F6-A170-B7B9F64EF4CF}']
    {class} function init(string_1: JString; string_2: JString; string_3: JString; string_4: JString; string_5: JString; string_6: JString; strings: TJavaObjectArray<JString>; string_7: JString; double: Double; double_1: Double): JCalendarParsedResult; cdecl;
  end;

  [JavaSignature('com/google/zxing/client/result/CalendarParsedResult')]
  JCalendarParsedResult = interface(JParsedResult)
    ['{CF033205-A049-4936-A048-DC4F6546B691}']
  ...
  JVINResultParserClass = interface(JResultParserClass)
    ['{C265C3EA-9607-4A01-BDAA-40ED424B4248}']
  ...
  JVINResultParser = interface(JResultParser)
    ['{A26803C2-931D-4984-A015-F45A41C7A32A}']
    function parse(result: JResult): JVINParsedResult; overload; cdecl;
  end;
  ...
  JTelParsedResultClass = interface(JParsedResultClass)
    ['{FC115957-591A-4553-8D45-F78D469DA597}']
    {class} function init(string_1: JString; string_2: JString; string_3: JString): JTelParsedResult; cdecl;
  end;

  [JavaSignature('com/google/zxing/client/result/TelParsedResult')]
  JTelParsedResult = interface(JParsedResult)
    ['{3AD68F84-144A-4177-85EE-8E8ADFD36903}']
    function getDisplayResult: JString; cdecl;
  ...
  JProductResultParserClass = interface(JResultParserClass)
    ['{092D656B-3C65-4BB5-9E59-4D43A7ACAD72}']
  ...
  JProductResultParser = interface(JResultParser)
    ['{30DE519D-4DFA-463D-9C31-81551E1F8E72}']
    function parse(result: JResult): JProductParsedResult; overload; cdecl;
  end;
  ...
  JEmailDoCoMoResultParserClass = interface(JAbstractDoCoMoResultParserClass)
    ['{7F2F4118-D906-4371-A353-B391B4B38196}']
  ...
  JEmailDoCoMoResultParser = interface(JAbstractDoCoMoResultParser)
    ['{4002224C-3C38-4367-A75A-0C011D05FD5E}']
    function parse(result: JResult): JEmailAddressParsedResult; overload; cdecl;
  end;
  ...
  JISBNResultParserClass = interface(JResultParserClass)
    ['{B7D63B1C-8AF3-43C8-A08D-0B4BED3D0572}']
  ...
  JISBNResultParser = interface(JResultParser)
    ['{F9B30107-5C53-4384-952F-9298B230AE0B}']
    function parse(result: JResult): JISBNParsedResult; overload; cdecl;
  end;
  ...
  JGeoResultParserClass = interface(JResultParserClass)
    ['{D533D599-BD00-41AC-AFBA-BC814DF66026}']
  ...
  JGeoResultParser = interface(JResultParser)
    ['{C1428171-A78C-456A-91C7-AA5F6E689682}']
    function parse(result: JResult): JGeoParsedResult; overload; cdecl;
  end;
  ...
  JEmailAddressResultParserClass = interface(JResultParserClass)
    ['{2791D328-F170-4488-91F3-DF87E8E3C289}']
  ...
  JEmailAddressResultParser = interface(JResultParser)
    ['{6542797C-0967-4FDF-84F9-BE06B7761B70}']
    function parse(result: JResult): JEmailAddressParsedResult; overload; cdecl;
  end;
  ...
  JAddressBookParsedResultClass = interface(JParsedResultClass)
    ['{E2931E28-AE4C-4B93-BEAD-395EA3E195F2}']
    {class} function init(strings: TJavaObjectArray<JString>; strings_1: TJavaObjectArray<JString>; strings_2: TJavaObjectArray<JString>; strings_3: TJavaObjectArray<JString>; strings_4: TJavaObjectArray<JString>; strings_5: TJavaObjectArray<JString>; strings_6: TJavaObjectArray<JString>): JAddressBookParsedResult; overload; cdecl;
    {class} function init(strings: TJavaObjectArray<JString>; strings_1: TJavaObjectArray<JString>; string_1: JString; strings_2: TJavaObjectArray<JString>; strings_3: TJavaObjectArray<JString>; strings_4: TJavaObjectArray<JString>; strings_5: TJavaObjectArray<JString>; string_2: JString; string_3: JString; strings_6: TJavaObjectArray<JString>; strings_7: TJavaObjectArray<JString>; string_4: JString; string_5: JString; string_6: JString; strings_8: TJavaObjectArray<JString>; strings_9: TJavaObjectArray<JString>): JAddressBookParsedResult; overload; cdecl;
  end;

  [JavaSignature('com/google/zxing/client/result/AddressBookParsedResult')]
  JAddressBookParsedResult = interface(JParsedResult)
    ['{948FE681-5BA0-4D7F-B852-258B2B1501D9}']
  ...
  JVCardResultParserClass = interface(JResultParserClass)
    ['{9E730294-5780-45B1-B3A9-64383256A987}']
  ...
  JVCardResultParser = interface(JResultParser)
    ['{33D8029E-FF32-4B02-9BF1-E476C5B6A3D7}']
    function parse(result: JResult): JAddressBookParsedResult; overload; cdecl;
  end;
  ...
  JTelResultParserClass = interface(JResultParserClass)
    ['{300485B6-7318-4781-A215-EBE895857174}']
  ...
  JTelResultParser = interface(JResultParser)
    ['{2D72596F-15D8-480F-926C-849135D92116}']
    function parse(result: JResult): JTelParsedResult; overload; cdecl;
  end;
  ...
  JURLTOResultParserClass = interface(JResultParserClass)
    ['{F8CA14EA-3FC9-4130-852D-70D1A12BF94F}']
  ...
  JURLTOResultParser = interface(JResultParser)
    ['{FFBDAD95-6098-4ED5-AD07-A55DBB2AAE18}']
    function parse(result: JResult): JURIParsedResult; overload; cdecl;
  end;
  ...
  JURIResultParserClass = interface(JResultParserClass)
    ['{43A259CB-3F74-4D33-9FBC-779EAD09EEA1}']
  ...
  JURIResultParser = interface(JResultParser)
    ['{9C86ACDB-E8BE-40AF-B1A6-75FCB070AFAA}']
    function parse(result: JResult): JURIParsedResult; overload; cdecl;
  end;
  ...
  JSMTPResultParserClass = interface(JResultParserClass)
    ['{3A723713-3C18-46DE-BDE2-FBAC59118186}']
  ...
  JSMTPResultParser = interface(JResultParser)
    ['{D4AA18C5-74CE-49E5-AA46-A05CEEABCC05}']
    function parse(result: JResult): JEmailAddressParsedResult; overload; cdecl;
  end;
  ...
  JAddressBookDoCoMoResultParserClass = interface(JAbstractDoCoMoResultParserClass)
    ['{24A7C684-9803-4CCC-8341-AE1272BC9981}']
  ...
  JAddressBookDoCoMoResultParser = interface(JAbstractDoCoMoResultParser)
    ['{55CE52DD-7C5D-4A38-AB2E-57E36E8A86A0}']
    function parse(result: JResult): JAddressBookParsedResult; overload; cdecl;
  end;
  ...
  JWifiResultParserClass = interface(JResultParserClass)
    ['{ECDE857B-DDA4-40E4-8979-0574C46D850C}']
  ...
  JWifiResultParser = interface(JResultParser)
    ['{B652B84D-1DF5-4860-A709-E13B1CB72FA9}']
    function parse(result: JResult): JWifiParsedResult; overload; cdecl;
  end;
  ...
  JSMSMMSResultParserClass = interface(JResultParserClass)
    ['{052E1BCC-BE18-4C55-A258-53A41B83CFAC}']
  ...
  JSMSMMSResultParser = interface(JResultParser)
    ['{C9057AB7-C397-4B4E-938D-996A0D64E50A}']
    function parse(result: JResult): JSMSParsedResult; overload; cdecl;
  end;
  ...
  JSMSTOMMSTOResultParserClass = interface(JResultParserClass)
    ['{EEB530F7-C77F-4FBF-9B8B-2D208C960EEE}']
  ...
  JSMSTOMMSTOResultParser = interface(JResultParser)
    ['{D1EDB73C-5283-473D-A3D7-3185C5A130D0}']
    function parse(result: JResult): JSMSParsedResult; overload; cdecl;
  end;
  ...
  JVEventResultParserClass = interface(JResultParserClass)
    ['{A65F4F12-D1FD-4B5E-BF51-2C43B4455445}']
  ...
  JVEventResultParser = interface(JResultParser)
    ['{64863BE3-7E0C-463C-B3FE-4E6A16C2CFF5}']
    function parse(result: JResult): JCalendarParsedResult; overload; cdecl;
  end;
  ...
  JBookmarkDoCoMoResultParserClass = interface(JAbstractDoCoMoResultParserClass)
    ['{955F48DF-C47D-42DC-87C7-FFD284CB5B02}']
  ...
  JBookmarkDoCoMoResultParser = interface(JAbstractDoCoMoResultParser)
    ['{B2F4F9F3-6B38-4DAB-BFBC-E24B106C3A17}']
    function parse(result: JResult): JURIParsedResult; overload; cdecl;
  end;
  ...
  JInvertedLuminanceSourceClass = interface(JLuminanceSourceClass)
    ['{E37E7649-3761-46F5-AEBF-71165B726174}']
  ...
  JInvertedLuminanceSource = interface(JLuminanceSource)
    ['{6DFEE269-077B-4FC0-843E-06874F8CA973}']
    function crop(int: Integer; int_1: Integer; int_2: Integer; int_3: Integer): JLuminanceSource; cdecl;
    function getMatrix: TJavaArray<Byte>; cdecl;
    function getRow(int: Integer; bytes: TJavaArray<Byte>): TJavaArray<Byte>; cdecl;
    function invert: JLuminanceSource; cdecl;
  ...
  JCode39ReaderClass = interface(JOneDReaderClass)
    ['{A6535D8B-DCE5-4EBC-9B4E-F0F2E42A2075}']
    {class} function init(boolean: Boolean; boolean_1: Boolean): JCode39Reader; overload; cdecl;
    {class} function init(boolean: Boolean): JCode39Reader; overload; cdecl;
    {class} function init: JCode39Reader; overload; cdecl;
  end;

  [JavaSignature('com/google/zxing/oned/Code39Reader')]
  JCode39Reader = interface(JOneDReader)
    ['{C1B94C29-DE32-405F-BF0F-8499DA6BC288}']
    function decodeRow(int: Integer; bitArray: JBitArray; map: JMap): JResult; cdecl;
  end;
  ...
  JUPCEANReaderClass = interface(JOneDReaderClass)
    ['{AA7415D2-5F74-4A7E-9777-BE4B452B1C60}']
  end;

  [JavaSignature('com/google/zxing/oned/UPCEANReader')]
  JUPCEANReader = interface(JOneDReader)
    ['{718F4518-C92F-40B5-BCF9-E518F3F18FB8}']
    function decodeRow(int: Integer; bitArray: JBitArray; map: JMap): JResult; overload; cdecl;
    function decodeRow(int: Integer; bitArray: JBitArray; ints: TJavaArray<Integer>; map: JMap): JResult; overload; cdecl;
  end;
  ...
  JCode93WriterClass = interface(JOneDimensionalCodeWriterClass)
    ['{3B878854-BD83-439C-97A6-0709329E4738}']
  ...
  JCode93Writer = interface(JOneDimensionalCodeWriter)
    ['{E1BEC34A-45BD-4F4C-B8BD-1E9595DC9A67}']
    function encode(string_1: JString): TJavaArray<Boolean>; cdecl;
  end;
  ...
  JCode93ReaderClass = interface(JOneDReaderClass)
    ['{6A80F2CE-57B4-45A6-AA13-4ED891A6953F}']
    {class} function init: JCode93Reader; cdecl;
  end;

  [JavaSignature('com/google/zxing/oned/Code93Reader')]
  JCode93Reader = interface(JOneDReader)
    ['{0BE42E48-571C-48F2-9B0F-6AB0261BB5C3}']
    function decodeRow(int: Integer; bitArray: JBitArray; map: JMap): JResult; cdecl;
  end;
  ...
  JCodaBarReaderClass = interface(JOneDReaderClass)
    ['{EA36728A-4A49-4F4D-B97D-969FFA4166B4}']
    {class} function init: JCodaBarReader; cdecl;
  end;

  [JavaSignature('com/google/zxing/oned/CodaBarReader')]
  JCodaBarReader = interface(JOneDReader)
    ['{4734D701-BBF6-443F-A174-401C2415EB47}']
    function decodeRow(int: Integer; bitArray: JBitArray; map: JMap): JResult; cdecl;
  end;
  ...
  JMultiFormatUPCEANReaderClass = interface(JOneDReaderClass)
    ['{01FC8CDE-F6C5-4708-BCEB-9EB3A2285353}']
  ...
  JMultiFormatUPCEANReader = interface(JOneDReader)
    ['{133AA7F7-0CC2-4BBD-A40B-1C0070797855}']
    function decodeRow(int: Integer; bitArray: JBitArray; map: JMap): JResult; cdecl;
    procedure reset; cdecl;
  end;
  ...
  JUPCEANWriterClass = interface(JOneDimensionalCodeWriterClass)
    ['{9DEE84C1-62BF-4261-B071-1F86AC908282}']
  ...
  JUPCEANWriter = interface(JOneDimensionalCodeWriter)
    ['{C78E6D52-9368-4BC9-9088-439C63A0D087}']
    function getDefaultMargin: Integer; cdecl;
  end;
  ...
  JEAN13ReaderClass = interface(JUPCEANReaderClass)
    ['{51C2741A-BAF7-481C-8974-13992E7C86A8}']
  ...
  JEAN13Reader = interface(JUPCEANReader)
    ['{D8BB5ED4-DDD3-4DB6-919F-2465408D8334}']
  end;
  ...
  JRSSExpandedReaderClass = interface(JAbstractRSSReaderClass)
    ['{F34863DF-FB53-4729-AFF4-45E48791B08F}']
  ...
  JRSSExpandedReader = interface(JAbstractRSSReader)
    ['{D5F540A8-CBCA-4306-8072-F418C6CD168B}']
    function decodeRow(int: Integer; bitArray: JBitArray; map: JMap): JResult; cdecl;
    procedure reset; cdecl;
  end;
  ...
  JRSS14ReaderClass = interface(JAbstractRSSReaderClass)
    ['{6A3C51F7-3948-47F6-A4F4-02D629B50213}']
  ...
  JRSS14Reader = interface(JAbstractRSSReader)
    ['{BC9F81F9-3D68-4DF9-9103-1B16FF36404E}']
    function decodeRow(int: Integer; bitArray: JBitArray; map: JMap): JResult; cdecl;
    procedure reset; cdecl;
  end;
  ...
  JCode128Reader = interface(JOneDReader)
    ['{D555D52D-7B28-4575-A144-F17D166D5180}']
    function decodeRow(int: Integer; bitArray: JBitArray; map: JMap): JResult; cdecl;
  end;
  ...
  JCode39WriterClass = interface(JOneDimensionalCodeWriterClass)
    ['{815EE761-F9B6-4919-85B4-33FCC41ACECE}']
  ...
  JCode39Writer = interface(JOneDimensionalCodeWriter)
    ['{C47AD710-C22A-4E8F-AC90-C0DE46C9A1E2}']
    function encode(string_1: JString): TJavaArray<Boolean>; cdecl;
  end;
  ...
  JEAN13Writer = interface(JUPCEANWriter)
    ['{812A7EF6-F4D6-4E86-B63F-72EF961A37D8}']
    function encode(string_1: JString): TJavaArray<Boolean>; cdecl;
  end;
  ...
  JMultiFormatOneDReaderClass = interface(JOneDReaderClass)
    ['{FD699968-36C5-4D24-B6B4-B5972641FB00}']
  ...
  JMultiFormatOneDReader = interface(JOneDReader)
    ['{4C3A0AE5-345E-4E66-B671-F4A353C5308E}']
    function decodeRow(int: Integer; bitArray: JBitArray; map: JMap): JResult; cdecl;
    procedure reset; cdecl;
  end;
  ...
  JHybridBinarizerClass = interface(JGlobalHistogramBinarizerClass)
    ['{4F63CC97-EFDD-4E6C-B4A6-CDE25B8694E6}']
  ...
  JHybridBinarizer = interface(JGlobalHistogramBinarizer)
    ['{C43E0536-8D81-4DDA-BE96-5EA37B618674}']
    function createBinarizer(luminanceSource: JLuminanceSource): JBinarizer; cdecl;
    function getBlackMatrix: JBitMatrix; cdecl;
  end;
